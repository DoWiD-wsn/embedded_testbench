...
class mic24045(object):
    ...
    def __init__(self, gpio, address=0x50, busnum=1):
        ...
        self.set_current_limit(self._ILIM_3)
        # Set the operating frequency to 500kHz
        self.set_frequency(self._FREQ_500)
        # Set the start-up delay to 0ms
        self.set_startup_delay(self._SUD_0)
        # Set the voltage margin to 0%
        self.set_voltage_margins(self._MRG_0)
        # Set the soft-start slope to its lowest value (0.16 V/ms)
        self.set_soft_start_slope(self._SS_016)
    ...
    def read_register_status(self):
        ...
        ret = self.read_register(self._REG_STATUS)
    ...
    def read_register_setting1(self):
        ...
        ret = self.read_register(self._REG_SET1)
        # Check if reading was successful
        if not ret:
            return False
        # Extract the single flags
    ...
    def read_register_setting2(self):
        ...
        ret = self.read_register(self._REG_SET2)
        # Check if reading was successful
        if not ret:
            return False
        # Extract the single flags
    ...
    def read_register_vout(self):
        ...
        return self.read_register(self._REG_VOUT)
    ...
    def read_register_command(self):
        ...
        ret = self.read_register(self._REG_CMD)
        # Check if reading was successful
        if not ret:
            return False
        # Extract the flag
    ...
    def clear_fault_flag(self):
        ...
        ret = self.write_register(self._REG_CMD, 0x01)
        # Check return status
        if not ret:
            return False
        else:
    ...
    def set_current_limit(self,ilim):
        ...
        return self.write_register(self._REG_SET1, msg)
    ...
    def set_startup_delay(self,delay):
        ...
        ret = self.read_register(self.M_REG_SET2)
        # Check return status
        if not ret:
            return False
        # Prepare the correct register value
        ...
        return self.write_register(self._REG_SET2, msg)
    ...
    def set_output_voltage(self,value):
        ...
        return self.write_register(self._REG_VOUT, value)
    ...
    def inc_output_voltage(self):
        ...
        ret = self.read_register(self._REG_VOUT)
        # Check return status
        if not ret:
            return False
        ...
        return self.write_register(self._REG_VOUT, ret)
